...
public class MessageHub : Hub
{
  ...
  public MessageHub(IUnitOfWork ouw, IMapper mapper, IHubContext<PresenceHub> presenceHub)
  {
    _ouw = ouw;
    _mapper = mapper;
  ...
  public override async Task OnConnectedAsync()
  {
    ...
    var messages = await _ouw.MessageRepository.GetMessageThread(Context.User.GetUsername(), otherUser);
